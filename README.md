...
```npm
yarn add @valasolutions/react-native-markdown
```
...
import Markdown, { MarkdownIt } from '@valasolutions/react-native-markdown';
...
// this shows you the tree that is used by the @valasolutions/react-native-markdown
const astTree = markdownItInstance.parse(copy, {});
console.log(astTree);

//this contains the html that would be generated - not used by @valasolutions/react-native-markdown but useful for reference
...
import Markdown, {
  ...
  tokensToAST,
  stringToTokens,
} from "@valasolutions/react-native-markdown";
